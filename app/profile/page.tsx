...
export default function ProfilePage() {
  ...
  const fetchProfile = () => {
    ...
    if (userData) {
      ...
      setUser(parsed);
      const [firstName, ...lastNameParts] = (parsed.name || 'John Doe').split(' ');
      setFormData({
        firstName: firstName || 'John',
        lastName: lastNameParts.join(' ') || 'Doe',
        email: parsed.email || 'john@example.com',
        phone: parsed.phone || '+91 94871 62485',
        address: parsed.address || 'Salem, Tamil Nadu',
        dateOfBirth: parsed.dateOfBirth || '1990-01-01',
        interests: parsed.interests || ['Worship Team', 'Prayer Team']
      });
    }
  };
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    ...
                    {isEditing ? (
                      ...
                      <span className="text-gray-700 dark:text-gray-300">{formData.address}</span>
                    )}
                  </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 dark:text-white">January 2023</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Status:</span>
                    <span className="bg-green-100 text-green-800 px-2 py-1 rounded-full text-sm">Active Member</span>
                  </div>
                  <div className="flex justify-between">
