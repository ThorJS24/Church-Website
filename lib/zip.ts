// A minimal, dependency-free ZIP (STORED/uncompressed entries only) writer.
// Deliberately skips DEFLATE compression — photos are already compressed
// (JPEG/PNG/WebP), so storing them uncompressed costs almost nothing and
// avoids needing a compression library. Implements just enough of the ZIP
// spec (local file headers, central directory, end-of-central-directory)
// for any standard unzip tool to open the result correctly.
